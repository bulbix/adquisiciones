...
namespace Adquisiciones.View.Modulos
{
    public partial class FrmModuloPedido : FrmModulo
    {
        ...
        private void gcPedidoDetalle_DragOver(object sender, DragEventArgs e)
        {
        ...
        private void gcPedidoDetalle_DragDrop(object sender, DragEventArgs e)
        {
            GridControl grid = sender as GridControl;
            GridView view = grid.MainView as GridView;
        ...
        const string OrderFieldName = "CveArt";
        ...
        private void gvPedidoDetalle_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void gvPedidoDetalle_MouseMove(object sender, MouseEventArgs e)
        {
            GridView view = sender as GridView;
